...
public class Main {
    public static void main(String[] args) {
        ...
        MovingDocument movingDocument = new MovingDocument(
                "789id",
                LocalDate.now(),
                s1,
                s2
        ...
        System.out.println("getPromoSum, без скидки: " + movingDocument.getPromoSum(new String[]{"000000000000005"}, Document.NO_DISCOUNT));

const oilPrices = [55.2, 54.8, 54.5, 55.1, 55.6, 56.2, 56.5, 56.8, 57.1, 57.5];

const tableBody = document.getElementById("tableBody");
const maxPriceSpan = document.getElementById("maxPrice");
const minPriceSpan = document.getElementById("minPrice");
const averageChangeSpan = document.getElementById("averageChange");
const averageIndexSpan = document.getElementById("averageIndex");
const positiveChangesSpan = document.getElementById("positiveChanges");
const negativeChangesSpan = document.getElementById("negativeChanges");
...
averageChangeSpan.textContent = (totalChange / (oilPrices.length - 1)).toFixed(
  2
);
averageIndexSpan.textContent = (totalIndex / (oilPrices.length - 1)).toFixed(2);
